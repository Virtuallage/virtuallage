...
public class AdviseUpdateDetailsDTO implements Serializable{
	...
	public AdviseUpdateDetailsDTO() {
		super();
	}
	public AdviseUpdateDetailsDTO(ProjectInventory projectInvetory,
